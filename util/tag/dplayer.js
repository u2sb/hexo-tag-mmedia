  ...
  generate() {
    ...
    tag += `
      <script>
        ...
        dp_${
          this.mmediaId
        }.on("fullscreen", function () { if (/Android|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) { screen.orientation.lock("landscape"); }});
        ${code}
      </script>
        `;
